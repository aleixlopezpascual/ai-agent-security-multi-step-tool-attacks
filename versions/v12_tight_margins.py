"""VARIANT (2026-08-23): v1_original.py's exact proven code with ONE change:
FILL_BUDGET_FRAC and REPLAY_SAFE_FRAC tightened from 0.95/0.98 to 0.99/0.99.

Rationale, backed by real evidence (see versions/README.md and
...
# 2026-08-23 tightening (see module docstring): 0.98 -> 0.99 REPLAY_SAFE_FRAC, and
# newly setting FILL_BUDGET_FRAC 0.95 -> 0.99, matching an externally-observed
# public kernel with the identical architecture already running safely at these
# values, post the 2026-08-05 partial-credit-on-replay-timeout fix.
