"""v32 (2026-08-26): Margin sweep 0.996 (between proven 0.995 and tested 0.997).

Rationale: Fine-grain margin sweep between v20's 0.995 (90.135 real) and v23's 0.997 
(88.920 real). All other parameters identical to v30 (zero-waste classification, 
optimal slow-row loosening).

Key test: does 0.996 land between the two, or is there a sharper boundary?
"""
...
REPLAY_SAFE_FRAC = 0.996       # 2026-08-26: fine-grain between v20 (0.995, 90.135) and v23 (0.997, 88.920)
