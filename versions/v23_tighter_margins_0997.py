"""v23 (2026-08-24): v20_tighter_margins_0995.py's exact proven code with ONE further
change: `REPLAY_SAFE_FRAC` 0.995 -> 0.997 (`FILL_BUDGET_FRAC` left at 0.99,
unchanged from v12/v20 -- confirmed dead code under `REPLAY_SAFE_SIZING=True`,
...
Rationale: v20_tighter_margins_0995.py (REPLAY_SAFE_FRAC=0.995) resolved real on
Kaggle at 90.135 (submission 55728233, COMPLETE, 2026-08-24) -- first submission
all session to beat the 88.740 anchor. This shows 0.995 is both safe and beneficial.
This submission is exactly the next logical step: one more small, bounded increment
(0.995 -> 0.997, closer to the theoretical 1.0 ceiling) on the one lever this session has
real positive evidence for. Submitted using today's remaining quota to exhaust our
daily limit of 5.
...
# 2026-08-24 tightening (see module docstring): v20's proven-safe 0.995 -> 0.997,
