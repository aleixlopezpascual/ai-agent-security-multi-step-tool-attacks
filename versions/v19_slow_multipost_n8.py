"""v19 (2026-08-24): pushes the SLOW_MULTIPOST_N sweep past the previously-tested range to N=8,
to see whether throughput keeps climbing with N or has already peaked/inverted somewhere in
the 2-4 range. Submitted before v16 (N=4), v17 (N=2), or v18 (N=3) resolve, per explicit user
direction to spend the 5th and final daily slot today even without a confirmed direction from
the sweep so far. This is the riskiest point in the sweep: replay cost scales roughly linearly
with N (the code's own historical comment: "~1.1x throughput: 4x posts cost ~3.6x replay" at
N=4), so at N=8 the replay-cost tax could plausibly outweigh the extra posts and regress below
the N=1 baseline -- this submission is what will tell us.
...
# v18 (2026-08-23): N raised to 3 -- see module docstring for rationale.
SLOW_MULTIPOST_N = 8          # v19 (2026-08-24): N raised to 8 -- see module docstring for rationale.
