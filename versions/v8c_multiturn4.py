"""VARIANT (2026-08-21): identical to versions/v8_multiturn.py with N_TURNS=4 instead
of 2, mapping the GPT-OSS amortization curve. Measured so far (300s budget, GPT-OSS):
N=1 (v1_original.py) = 2.53 raw/sec, N=2 (v8_multiturn.py) = 3.00 raw/sec (+19%),
N=3 (v8b_multiturn3.py) = 3.21 raw/sec (+27%, +7% over N=2, diminishing marginal
gain). This variant checks whether the trend keeps improving, plateaus, or reverses
at N=4 -- purely local research, NOT queued for submission without its own
validation. See versions/README.md.
...
N_TURNS = 4                   # 2026-08-21 variant: 4 (mapping the amortization curve)
