...
SPLIT_THRESHOLD_S = 0.5  # RESEARCH TEST: force slow classification on local hardware, SLOW_MULTIPOST_N stays 1 (control)       # classify "slow" (gpt_oss) above this mean latency;
