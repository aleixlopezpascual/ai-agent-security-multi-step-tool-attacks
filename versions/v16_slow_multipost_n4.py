...
k1-ceiling-decision-2026-08-23). SPLIT_THRESHOLD_S, REPLAY_SAFE_FRAC,
FILL_BUDGET_FRAC, BURST_K, and every other knob are untouched from v1_original.py
-- this is a single-variable test of SLOW_MULTIPOST_N alone.
