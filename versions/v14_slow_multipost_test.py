...
SPLIT_THRESHOLD_S = 0.5  # RESEARCH TEST: force slow classification on local hardware       # classify "slow" (gpt_oss) above this mean latency;
...
SLOW_MULTIPOST_N = 4          # RESEARCH TEST 2026-08-23: activate forged multi-post lever on the classified-slow row only
