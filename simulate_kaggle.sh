...
# Usage: ./simulate_kaggle.sh [ATTACK_PY]   (default: versions/v20_tighter_margins_0995.py)
ATTACK="${1:-versions/v20_tighter_margins_0995.py}"
...
python3 evaluate_local.py --attack "$ATTACK" --model both --budget 8750
